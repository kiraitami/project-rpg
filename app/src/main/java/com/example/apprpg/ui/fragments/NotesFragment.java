...
public class NotesFragment extends Fragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        orderByFavorite = sharedPreferences.getBoolean(getResources().getString(R.string.order_by_favorites_notes_key),false);
    ...
    private void saveOrderByFavorites(){
        ...
        editor.putBoolean(getResources().getString(R.string.order_by_favorites_notes_key), orderByFavorite);
        editor.apply();
    }
